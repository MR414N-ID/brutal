...
def balik():
    ...
    if f == "y":
       ...
       sys.exit()
       print("\033[1;93mkalo ada yg mau di tanyakan silahkan hubungi nomor waku😉")
clear()
os.system("print BRUTAL|figlet -f banner|lolcat -a")
...
os.system("print TEAM=INDONESIAN MULTITALENTED COMUNITY [IMC]|lolcat -a")
os.system("print ==============================================|lolcat -a")
def kata(s):
    for c in s + "\n":
        sys.stdout.write(c)
